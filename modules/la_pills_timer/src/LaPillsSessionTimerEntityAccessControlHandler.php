 ...
 */
class LaPillsSessionTimerEntityAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\la_pills_timer\Entity\LaPillsSessionTimerEntityInterface $entity */
    switch ($operation) {
      case 'view':
