...
/**
 * Access controller for the La Pills Timer Session entity.
 *
 * @see \Drupal\la_pills_timer\Entity\LaPillsTimerSessionEntity.
 */
class LaPillsTimerSessionEntityAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\la_pills_timer\Entity\LaPillsTimerSessionEntityInterface $entity */
    switch ($operation) {
      case 'view':
